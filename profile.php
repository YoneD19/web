    ...
    if(!empty($_SESSION['id'])){
        if(isset($_GET["username"])){
            ...
            if(mysqli_num_rows($result) >0){
                ...
                $email = $row["email"];
		$id = $row['id'];
    	$img=mysqli_query($mydb,"select * from img where user_id='$id'");
	$imgname=mysqli_fetch_assoc($img)['img'];
            }else{
...
<?php
	...
	echo  '<img src="/uploads/viewimg.php?name=';echo $imgname;echo'" width="100" height="100" ><br>';
}
 ?>
